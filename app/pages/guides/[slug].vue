...
.guide-page::before {
  ...
  background:
    ...
    radial-gradient(48% 42% at 2% 38%, rgba(64, 126, 116, 0.12), transparent 72%),
    radial-gradient(38% 30% at 63% 76%, rgba(166, 104, 76, 0.065), transparent 76%);
}
.guide-page::after {
  content: '';
  position: fixed;
  ...
  background-image:
    ...
    radial-gradient(circle at 46% 77%, rgb(142 215 203 / 26%) 0 0.65px, transparent 1px);
  background-size:
    23rem 19rem,
    29rem 27rem,
    37rem 31rem;
