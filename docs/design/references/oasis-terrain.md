...
If shipping these models, retain a small source/license notice alongside the selected assets and update [asset licenses](../../legal/asset-licenses.md) with the exact shipped filenames and runtime recoloring. The full source archive is unnecessary in the website payload.
